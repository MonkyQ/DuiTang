...
- (void)tableViewDidTriggerHeaderRefresh
{
    ...
    dispatch_async(refreshQueue, ^{
        ...
        NSLog(@"%d",[[[EMClient sharedClient] groupManager] getAllGroups].count);
        NSArray * list= [[EMClient sharedClient].groupManager getAllGroups];
        
        //NSArray * list= allgroup.list;
        for (EMGroup * group  in list)
        {
            EMConversation * conversion = [[EMClient sharedClient].chatManager getConversation:group.groupId type:EMConversationTypeGroupChat createIfNotExist:YES];
            [conversations addObject:conversion];
        }
